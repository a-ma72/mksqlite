...
static const char* compressor_to_clib(int compressor)
{
  static const char *unknown="Unknown (please report this to the maintainers)";
...
static const char *clibcode_to_clib(int code)
{
...
static int compressor_to_compcode(const char *compressor_)
{
  int code = -1;
...
int blosc_set_compressor(const char *compressor_)
{
  int code;
...
int blosc_get_complib_info(const char *compressor_, const char **complib, const char **version)
{
  int clibcode;
  const char *strclib, *strversion = NULL;
